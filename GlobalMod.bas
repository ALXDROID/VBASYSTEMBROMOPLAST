...
'        Optional Button3 As String, Optional Picture As String = "C:\Users\aphex\OneDrive - Aiep\Pictures\serp.png") As String
'
'    Dim Args As String
'
...
'    MsgBox Args
'
'    DoCmd.OpenForm "MyMsgBox", acNormal, OpenArgs:=Args ', WindowMode:=acDialog
'
